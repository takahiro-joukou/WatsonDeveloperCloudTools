...
public class GoToNodeDetailsPage extends ActionSectionHolderDetailsPage {

  /** Section title */
  private static final String GOTO_SECTION_TITLE = "GoTo";
  ...
  public void createContents(Composite parent) {
    ...
    // GoTo Section
    createGoToSection(parent, toolkit);
   ...
   * @param toolkit
   */
  private void createGoToSection(Composite parent, FormToolkit toolkit) {
    Section section = toolkit.createSection(parent, Section.TITLE_BAR);
    section.setText(GOTO_SECTION_TITLE);
    ...
    selectButton.addSelectionListener(new SelectionListener() {
      ...
      public void widgetSelected(SelectionEvent e) {
        SelectFlowNodeDialog dialog = new SelectFlowNodeDialog(WidgetsFactory.getShell(), goToNode);
  ...
  public void selectionChanged(IFormPart part, ISelection selection) {
    ...
    goToNode = (GoToNode) ((IStructuredSelection) selection).getFirstElement();
    selectedAction = null;
    ...
    // comment
    String comment = goToNode.getComment();
    if (comment != null) {
      commentText.setText(comment);
    }

    // isOffline
    isOfflineCheckButton.setSelection(goToNode.getIsOffline());
  ...
  public void clearPage() {
    ...
    actionTableViewer.setInput(goToNode.getActions());
  }
  ...
  private class CommentTextListener implements ModifyListener {
    ...
    public void modifyText(ModifyEvent e) {
      goToNode.setComment(commentText.getText());
  ...
  private class RefTextListener implements ModifyListener {
    @Override
    public void modifyText(ModifyEvent e) {
      goToNode.setRef(refText.getText());
  ...
  private class IsOfflineCheckButtonListener implements SelectionListener {
    @Override
    public void widgetSelected(SelectionEvent e) {
      goToNode.setIsOffline(isOfflineCheckButton.getSelection());
      masterPart.markDirty();
    }
