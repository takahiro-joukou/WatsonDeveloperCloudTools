 ...
 *       &lt;sequence>
 *         &lt;element name="folder" type="{}folderNodeType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class FlowType {
    ...
    protected List<FolderNodeType> folder;
     ...
     * 
     */
    public List<FolderNodeType> getFolder() {
        if (folder == null) {
            folder = new ArrayList<FolderNodeType>();
        }
        return this.folder;
    }
